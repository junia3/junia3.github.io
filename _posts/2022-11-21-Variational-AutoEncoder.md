...
![Untitled](Variational%20AutoEncoder(VAE)%205d7b7a46a7e241b1a69e55d42d372c25/Untitled.png)

딥러닝을 배제하고 **무언가를 생성하는 모델**을 생각해보자. 그 무언가에 해당하는 **modality**는 시각적인 정보가 될 수도 있고, 사람이나 다양한 사물, 동물의 소리를 모사한 형태의 음성 정보가 될 수도 있으며 혹은 획기적인 디자인이나 심금을 울리는 글 형태가 될 수도 있다.
...
- **Likelihood-based frameworks**
    ...
    - flow-based models
    - diffusion models(**~~다음 주 리뷰 내용 ㅎㅎ ㅠㅠㅠㅠ~~**)
...
![Untitled](Variational%20AutoEncoder(VAE)%205d7b7a46a7e241b1a69e55d42d372c25/Untitled%201.png)

언어 모델 중 유명한 [BERT](https://arxiv.org/pdf/1810.04805.pdf)가 바로 denoising autoencoder의 메커니즘과 동일한데, 바로 다음과 같은 구조를 가지는 것을 볼 수 있다.

![Untitled](Variational%20AutoEncoder(VAE)%205d7b7a46a7e241b1a69e55d42d372c25/Untitled%202.png)
...
![화면 캡처 2022-05-24 150329.png](Variational%20AutoEncoder(VAE)%205d7b7a46a7e241b1a69e55d42d372c25/%ED%99%94%EB%A9%B4_%EC%BA%A1%EC%B2%98_2022-05-24_150329.png)
...
![Untitled](Variational%20AutoEncoder(VAE)%205d7b7a46a7e241b1a69e55d42d372c25/Untitled%203.png)
...
2. Minimize KLD of approximation $q_{\phi}(z | x)$ from true posterior($p(z | x)$) —> **inference model** becomes better
...
2. **Output distribution $p(x | z)$를 정의하는 방식**
3. $**z$ 전체에 대해서 어떻게 적분하지? ㅠ**
...
![Untitled](Variational%20AutoEncoder(VAE)%205d7b7a46a7e241b1a69e55d42d372c25/Untitled%204.png)
...
![Untitled](Variational%20AutoEncoder(VAE)%205d7b7a46a7e241b1a69e55d42d372c25/Untitled%205.png)
...
![Untitled](Variational%20AutoEncoder(VAE)%205d7b7a46a7e241b1a69e55d42d372c25/Untitled%206.png)
