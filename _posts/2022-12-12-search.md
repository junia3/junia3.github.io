---
title: github.io 검색 엔진(구글/네이버)에 노출시키기
layout: post
...
# feed.xml 파일 만들기
저거 기다리면서 _config.yml 파일과 같은 위치에 feed.xml을 만들어주었다. 어차피 사이트맵 제출이랑 RSS 제출 때 써야하므로..
<script src="https://gist.github.com/junia3/0daab3c7b6bb37a411ff225e0757a82c.js"></script>

---

# 소유확인 절차 및 사이트맵/RSS 제출
...
좌측의 요청을 클릭하면 RSS랑 사이트맵을 제출하는 곳이 있다. 들어가서 각각 내보도록 하자.
